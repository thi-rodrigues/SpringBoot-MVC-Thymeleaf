...
@Component
public class MyErrorView implements org.springframework.boot.autoconfigure.web.servlet.error.ErrorViewResolver {
	...
	public ModelAndView resolveErrorView(HttpServletRequest request, HttpStatus status, Map<String, Object> map) {
		...
		switch (status.value()) {
		case 404:
			model.addObject("error", "Página não encontrda.");
